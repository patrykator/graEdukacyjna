      ...
      <div>
        ...
        {current ? (
          <div className="mb-4 border-6   border-gray-800 rounded-lg p-4  w-[500px]">
            <h3 className="m-0 text-center">{current.question}</h3>
                ...
                return (
                  <li key={key}>
                    <button
                      ...
                      className={`px-2 py-1 rounded ${isChosen
                          ? "bg-blue-600 text-white  border-4   border-gray-800 rounded-lg p-4  w-[400px]"
                          : "bg-blue-400 hover:bg-blue-500  border-4 border-gray-800 rounded-lg p-4  w-[400px]"
                        }`}
                    >
        ...
        <div className="mt-3">
          {currentQuestion === 1 ? (
            <div className="opacity-50 cursor-not-allowed border-4 bg-blue-500 border-gray-800 rounded-lg p-4 w-[120px] float-left">
              <button disabled>Poprzednie</button>
            </div>
          ) : (
            <div className="border-4 bg-blue-500 border-gray-800 rounded-lg p-4 w-[120px] float-left">
              <button onClick={() => prev()}>Poprzednie</button>
            </div>
          )}
          ...
          <button
            ...
            className="ml-2 border-4 bg-blue-500 border-gray-800 rounded-lg p-4 w-[120px] float-left"
          >
